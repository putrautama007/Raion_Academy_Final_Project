...
import com.example.putrautama.rachat.core.chat.logout.LogoutContract;
import com.example.putrautama.rachat.core.chat.logout.LogoutPresenter;
import com.example.putrautama.rachat.ui.Adapter.UserListingPagerAdapter;
...
public class UserListingActivity extends AppCompatActivity implements LogoutContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activty_user_listing);
        bindViews();
        init();
    }
